...
public class Setup implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        CanvasAPIRunner f = new CanvasAPIRunner();
        f.save(districtUrl.getText(), apiKey.getText());
        System.out.println("" + districtUrl.getText() + apiKey.getText());
        boolean canRun = false;
        try {
            String[] load = f.returnLoad();
